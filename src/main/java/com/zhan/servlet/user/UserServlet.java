...
public class UserServlet extends HttpServlet {
    ...
    //修改密码
    public void updatePwd(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ClassNotFoundException {
        //从Session里面拿ID;
    ...
    //query方法
    public void query(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ClassNotFoundException {
